"""
cli.py -- KDP Discovery Engine Pro CLI Orchestrator
...
Usage:
    python src/cli.py "low fodmap cookbook for kids" --sheet-id "abc123"
    python main.py --cli "adhd planner for adults"
...
# Each module runs its config loader and logging at import time.
try:
    ...
    print("Ensure src/core/scraper.py, src/core/analyzer.py, src/core/exporter.py all exist.")
    sys.exit(1)
